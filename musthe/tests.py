...
class TestsForJesus(unittest.TestCase):
    ...
    def test_note_scales(self):
        self.assertEqual(str(Scale(Note('C'), 'major')),            'C D E F G A B C')
        self.assertEqual(str(Scale(Note('C'), 'natural_minor')),    'C D Eb F G Ab Bb C')
        self.assertEqual(str(Scale(Note('C'), 'harmonic_minor')),   'C D Eb F G Ab B C')
        self.assertEqual(str(Scale(Note('C'), 'melodic_minor')),    'C D Eb F G A B C')
        self.assertEqual(str(Scale(Note('C'), 'dorian')),           'C D Eb F G A Bb C')
        self.assertEqual(str(Scale(Note('C'), 'locrian')),          'C Db Eb F Gb Ab Bb C')
        self.assertEqual(str(Scale(Note('C'), 'lydian')),           'C D E F# G A B C')
        self.assertEqual(str(Scale(Note('C'), 'mixolydian')),       'C D E F G A Bb C')
        self.assertEqual(str(Scale(Note('C'), 'phrygian')),         'C Db Eb F G Ab Bb C')
        self.assertEqual(str(Scale(Note('C'), 'major_pentatonic')), 'C D E G A C')
        self.assertEqual(str(Scale(Note('C'), 'minor_pentatonic')), 'C Eb F G Bb C')
